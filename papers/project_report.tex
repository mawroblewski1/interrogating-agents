...
\begin{figure}[h]
  ...
  \caption{Mean stance per topic and condition ($\pm$1 SEM, standard error of
    the mean). Points show mean stance across all turns per condition, with error
    bars indicating variability across legs. Treatment (orange) trends toward the
    Interrogator target, while control (blue) drifts or plateaus. Aggregation
    across opposing initial positions ($+2$/$-2$) can attenuate directionality;
