...
Table~\ref{tab:results} reports per-topic metrics. ~\ref{fig:fig3}
...
Magnitude effects are mixed (~\ref{fig:fig1}): Transit shows a strong
...
\begin{}[h]
  \centering
  \includegraphics[width=\linewidth]{fig3_directional_accuracy.png}
...
\begin{}[h]
  \centering
  \includegraphics[width=\linewidth]{fig1_magnitude_by_condition.png}
...
\begin{}[h]
  \centering
  \includegraphics[width=\linewidth]{fig2_trajectories.png}
  \caption{Mean stance per topic and condition ($\pm$1 SEM, standard error of the
    mean). Points show mean stance across all turns per condition, with error bars
    indicating variability across legs. Treatment (orange) trends toward the
    Interrogator target, while control (blue) drifts or plateaus. Aggregation across
    opposing initial positions (+2/−2) can attenuate directionality; see Figure 1
